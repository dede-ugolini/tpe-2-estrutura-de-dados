...
Além disso, deverá escolher entre as estruturas auxiliares Pilha ou Fila para
gerenciar as operações sobre essa lista.
Por fim, o grupo deverá aplicar um algoritmo de ordenação à sua escolha sobre os dados
...
O aluno deve escolher apenas uma:Opção A – Pilha
